...
const useStore = create((set, get) => ({
  ...
  // Step 2: Scale
  origin: null,        // { x, y } in floor plan pixels
  scalePoints: null,   // { p1: {x,y}, p2: {x,y} } in pixels
  realWorldDistance: null,
  pixelsPerMeter: null,

  // Step 3: Zones & Obstacles
  zones: [],      // { id, name, type, points: [{x,y},...] } — points in meters
  obstacles: [],  // { id, name, points: [{x,y},...] } — points in meters
