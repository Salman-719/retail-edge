...
def register_routers(app: FastAPI) -> None:
    from app.api import stores, floor_plans, zones, cameras, videos, calibration, calibration_files, tracking, employees
    ...
    app.include_router(calibration_files.router,  prefix="/api/stores", tags=["calibration-files"])
